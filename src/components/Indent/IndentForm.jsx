  ...
  const handleSubmitForm = async (e) => {
    ...
    try {
      ...
      const taskData = {
        ...
        "Task Start Date": startDate ? (startTime ? `${startDate} ${startTime}:00` : `${startDate} 00:00:00`) : "",
        "Task Ending Date": endTaskDate ? (endTime ? `${endTaskDate} ${endTime}:00` : `${endTaskDate} 00:00:00`) : "",
